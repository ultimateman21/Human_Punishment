...
from PyQt6.QtWidgets import QVBoxLayout, QWidget, QGraphicsView, QGraphicsScene, QApplication, QGraphicsPixmapItem, QDialog, QLabel, QPushButton, \
    QHBoxLayout
...
class CardPreviewDialog(QDialog):
    ...
    def __init__(self, im_path, desc, type_, parent=None):
        ...
        if type_ == 'action':
            ...
            if im_path == '../source/cards/front/46.png':
            ...
            elif im_path == '../source/cards/front/46-1.png':
...
class CardScene(QGraphicsScene):
    ...
    def __init__(self, name, param, parent=None):
        ...
        # Добавляем фон
        # self.background_item = QGraphicsPixmapItem(QPixmap("zadniki/table_field.png"))
